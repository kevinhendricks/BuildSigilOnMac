...
To build current Sigil master from source needs a complete build of Qt 6.6.2
and Python 3.11.3 or later.
...
Sigil uses Qt-6.6.2 currently, see  
...
Qt6.6.2 needs a number of patches and bug fixes to make is usable and 
